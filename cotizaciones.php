...
<div id="tabs">
  <ul>
    <li class="hacer"><a href="#hacer">Cotizare</a></li>
  ...
  <div id="hacer">
    ...
    <?php } ?>
        ...
        <!--- quitar el style del div de abajo -->
        <div class="campo_form celda" style="text-align: left; padding-left: 110px;">
      ...
      <div class="tabla">
        <div class="celda" style=" width:600px;">
          ...
          <div class="campo_form">
			...
			<input type="text" id="telefonoContacto" name="telefonoContacto" class="text_largo telefonoContacto"/>
          </div>
